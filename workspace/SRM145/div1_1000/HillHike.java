...
// CUT begin
	public static void main(String[] args){
		System.err.println("HillHike (1000 Points)");
		System.err.println();
	...
	static void runTest(HashSet<Integer> caseSet) {
	    ...
	    while (true) {
            ...
            int[] landmarks = new int[Integer.parseInt(Reader.nextLine())];
            for (int i = 0; i < landmarks.length; ++i)
                landmarks[i] = Integer.parseInt(Reader.nextLine());
            Reader.nextLine();
        ...
        int T = (int)(System.currentTimeMillis() / 1000) - 1514300812;
	...
	static boolean doTest(int distance, int maxHeight, int[] landmarks, long __expected) {
	...
	static class Reader {
        private static final String dataFileName = "HillHike.sample";
